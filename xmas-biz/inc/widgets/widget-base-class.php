 ...
 * @since 1.0.0
 */
class Xmas_Biz_Widget_Base extends WP_Widget {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'xmas-biz' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'xmas-biz' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'xmas-biz' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr_x( 'X', 'Remove', 'xmas-biz' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
