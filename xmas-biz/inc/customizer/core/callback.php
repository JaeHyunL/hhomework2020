...
if ( ! function_exists( 'xmas_biz_is_select_page_slider' ) ) :
	 ...
	 */
	function xmas_biz_is_select_page_slider( $control ) {
...
if ( ! function_exists( 'xmas_biz_is_select_cat_slider' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function xmas_biz_is_select_cat_slider( $control ) {
