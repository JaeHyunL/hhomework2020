...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <?php if (!is_single()) { ?>
        ...
        <div class="entry-meta">
            <?php xmas_biz_posted_on(); ?>
            <?php xmas_biz_entry_footer(); ?>
        </div><!-- .entry-meta -->
        <?php $archive_layout = xmas_biz_get_option('archive_layout'); ?>
        <?php $archive_layout_image = xmas_biz_get_option('archive_layout_image'); ?>
        ...
        <div class="entry-content twp-entry-content <?php echo esc_attr($full_width_content); ?>">
            ...
            <?php if ('full' == $archive_layout) : ?>
                ...
                /* translators: %s: Name of current post. */
                    wp_kses(__('Continue reading %s <span class="meta-nav">&rarr;</span>', 'xmas-biz'), array('span' => array('class' => array()))),
